...
$$ u_i \mid u\_{-i} \sim N!\left(\bar{u}\_{\delta\_i}, \frac{\sigma_u^2}{n_{\delta_i}}\right) $$
...
$$ \bar{u}\_{\delta_i} = \frac{1}{n_{\delta_i}} \sum{j \in \delta\_i} u_j $$
...
Critiques to the BYM: - As indicated by Wu & Banerjee (2024), Simpson et al. (2017) and Riebler et al. (2016) the error components are not identifiable and scaling issues complicate interpretation of the variance parameters in the BYM model.
